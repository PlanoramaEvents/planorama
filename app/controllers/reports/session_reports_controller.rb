class Reports::SessionReportsController < ApplicationController
  ...
  def participants_over_session_limits
    ...
    worksheet = workbook.add_worksheet("Participants Over Daily Limits")
    ...
    send_data workbook.read_string,
              filename: "ParticipantsOverDailyLimits#{Time.now.strftime('%m-%d-%Y')}.xlsx",
  ...
  def panels_with_too_many_people
    ...
    workbook = FastExcel.open(constant_memory: true)
    worksheet = workbook.add_worksheet("Panels with Too Many Participants")
