class ReportsController < ApplicationController
  ...
  def people_and_submissions
    ...
    worksheet = workbook.add_worksheet("Participants and Survey Submissions")
    ...
    send_data workbook.read_string,
              filename: "ParticipantsAndSubmissions#{Time.now.strftime('%m-%d-%Y')}.xlsx",
  ...
  def assigned_sessions_by_participant
    ...
    send_data workbook.read_string,
              filename: "AssignedSessionsByParticipant#{Time.now.strftime('%m-%d-%Y')}.xlsx",
              disposition: 'attachment'
  end
  ...
  def participant_availabilities
    ...
    Time.use_zone(timezone) do
      ...
      send_data workbook.read_string,
                filename: "ParticipantAvailabilities#{Time.now.strftime('%m-%d-%Y')}.xlsx",
                disposition: 'attachment'
    end
  end
  ...
  def session_selections
    ...
    send_data workbook.read_string,
              filename: "SessionSelections#{Time.now.strftime('%m-%d-%Y')}.xlsx",
              disposition: 'attachment'
  end
