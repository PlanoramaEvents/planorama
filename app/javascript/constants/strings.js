...
module.exports = {
    ...
    SURVEY_SAVE_ERROR_PUBLISH: (errorCode) => twoLines("Survey failed to be published.", `Error code: ${errorCode}`),
    SURVEY_SAVE_SUCCESS_CLOSE: "Survey successfully closed.",
    SURVEY_SAVE_ERROR_CLOSE: (errorCode) => twoLines("Survey failed to be closed.", `Error code: ${errorCode}`),
    ...
    QUESTION_SAVE_ERROR: (errorCode) => twoLines("Question failed to be saved.", `Error code: ${errorCode}`),
    QUESTION_DELETE_SUCCESS: "Question successfully deleted",
    QUESTION_DELETE_ERROR: (errorCode) => twoLines("Question failed to be deleted.", `Error code: ${errorCode}`),
    ...
    PAGE_MERGE_ERROR: (errorCode) => twoLines("Page failed to be merged.",  `Error code: ${errorCode}`),
