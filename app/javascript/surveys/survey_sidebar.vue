    ...
    <sidebar-vue v-if="survey" model="survey">
      ...
      <template #content v-if="survey">
        ...
        <div class="float-right d-flex justify-content-end">
          <b-button title="Survey Link" variant="primary" :href="surveyLink(survey)" target="_blank"><b-icon-link45deg variant="white"></b-icon-link45deg></b-button>
          <b-button title="Preview Survey" class="mx-2" variant="primary" :href="previewLink(survey)" target="_blank"><b-icon-eye-fill variant="white"></b-icon-eye-fill></b-button>
