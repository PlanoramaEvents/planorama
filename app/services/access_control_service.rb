  ...
  def self.attribute_meta_data
    {
      ...
      Person: {
        ...
        website: { sensitive: false, linkable: false, type: :string, hidable: true},
        twitter: { sensitive: false, linkable: false, type: :string, hidable: true},
        fediverse: { sensitive: false, linkable: false, type: :string, hidable: true},
        bsky: { sensitive: false, linkable: false, type: :string, hidable: true},
        othersocialmedia: { sensitive: false, linkable: false, type: :string, hidable: true},
        facebook: { sensitive: false, linkable: false, type: :string, hidable: true},
        linkedin: { sensitive: false, linkable: false, type: :string, hidable: true},
        twitch: { sensitive: false, linkable: false, type: :string, hidable: true},
        youtube: { sensitive: false, linkable: false, type: :string, hidable: true},
        instagram: { sensitive: false, linkable: false, type: :string, hidable: true},
        flickr: { sensitive: false, linkable: false, type: :string, hidable: true},
        reddit: { sensitive: false, linkable: false, type: :string, hidable: true},
        tiktok: { sensitive: false, linkable: false, type: :string, hidable: true},
        ...
        othered: { sensitive: true, linkable: true, type: :text, hidable: false},
