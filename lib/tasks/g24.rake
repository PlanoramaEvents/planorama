namespace :g24 do
  ...
  def sec_rooms
    ...
    candidates = [
        ...
        {venue_id: sec.id, name: "Dockhart 1", purpose: "Programme room", sort_order: 145},
        {venue_id: sec.id, name: "Dockhart 2", purpose: "Green Room / Table Talks / Prog Ops?", sort_order: 150},
