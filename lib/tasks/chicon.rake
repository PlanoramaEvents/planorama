    ...
    if hyatt.rooms.count == 0
      ...
      Room.create!(
        [
          ...
          {venue_id: hyatt.id, name: "Gallery Boardroom 1", floor: "Skyway Level, West Tower", purpose: "Safer Spaces", sort_order: 110},
          {venue_id: hyatt.id, name: "Gallery Boardroom 2", floor: "Skyway Level, West Tower", purpose: "Safer Spaces", sort_order: 111},
          {venue_id: hyatt.id, name: "Gallery Boardroom 3", floor: "Skyway Level, West Tower", purpose: "Safer Spaces", sort_order: 112},
          {venue_id: hyatt.id, name: "Gallery Boardroom 4", floor: "Skyway Level, West Tower", purpose: "Safer Spaces", sort_order: 113},
          {venue_id: hyatt.id, name: "Gallery 5", floor: "Skyway Level, West Tower", purpose: "Safer Spaces", sort_order: 114},
