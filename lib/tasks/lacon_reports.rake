  ...
  REPORTS = [
    {
      ...
      description: "Survey - Ideas for Program Items etc",
      query: [
        {
          field: "question_id",
          op: '=',
      ...
      questions: [
        {id: "4f5d73fb-ae2d-4500-bbab-72868926b89a", label: "Attendance Type"},
        {id: "e2c0f6d9-6b60-4de3-94e2-b9b7a9316a5f", label: "Where if online"},
        {id: "6f1fbfe7-1819-446d-860c-46bdc6582a01", label: "Bio"},
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "89794376-82f7-4d3a-8e0a-489b88907169", label: "Accessibility"},
        {id: "cba6d692-5e8e-44ae-8461-ba9276a506ee", label: "First Worldcon?"},
        {id: "006eea82-c85d-4850-8dbb-a5631e5de6ec", label: "Past Experience"},
        {id: "f36d7366-6970-4013-971d-c0e72ff47f89", label: "Past Panel Moderation"},
        {id: "6e366e05-4142-4abf-8042-4ee5650a04dd", label: "Excited to Talk About"},
        {id: "461cbd09-1e5e-46ee-9200-5849e1fe0eef", label: "Panel Ideas"},
        {id: "1f119e51-0961-4450-a47f-28cdd05abd8a", label: "6 to 12 ideas"},
        {id: "0a0ebd9b-c9f1-4aa0-a0d8-9a94edfaaff2", label: "13 - 18 ideas"},
        {id: "4fa84c9e-077e-4014-bca9-e97391af2326", label: "Ideas not covered in prior questions"},
        {id: "96f563ed-b64e-4a8a-a901-8a39ea86747e", label: "Demographic Categories"},
        {id: "9e2564b1-3578-4477-908c-b4d3e58132e2", label: "Demographic Categories not to discuss"}
      ],
      sort_order: 1
    },
    {
      survey_id: '74436fe3-e61b-4a8c-91c3-c32a4238df71',
      name: 'Workshops',
      description: 'Survey - People willing to do workshops',
      query: [
        {
          field: "question_id",
          op: '=',
      ...
      questions: [
        ...
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "89794376-82f7-4d3a-8e0a-489b88907169", label: "Accessibility"},
        {id: "585b5aae-fef9-40ec-a5dd-e3c2028935db", label: "Accessibility Concerns"},
        {id: "cba6d692-5e8e-44ae-8461-ba9276a506ee", label: "First Worldcon?"},
        {id: "dbca83ea-17db-42b0-be9c-cf882aedf2ea", label: "Previous Worldcons?"},
        {id: "957538df-074f-4b1c-882a-f9928f0a8238", label: "Interest in Leading following Workshops?"}
      ],
      sort_order: 2
    },
    {
      ...
      questions: [
        {id: "4f5d73fb-ae2d-4500-bbab-72868926b89a", label: "Attendance Type"},
        {id: "6f1fbfe7-1819-446d-860c-46bdc6582a01", label: "Bio"},
        {id: "771fe6b4-dea6-466b-9634-b8425a11eb4d", label: "Pronunciation Guide"},
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "e350f72b-d80a-4ee1-a930-d3ec07ed9413", label: "Other Languages"},
        {id: "8250d215-6fd2-4367-a03c-b03a597f6bc2", label: "Interested Items"},
        {id: "91f0fb22-5e91-45c8-ac72-044dc5d304e3", label: "Consent - Sensitive Info"},
        {id: "05501da1-e501-41a0-adab-0d027dc20c8d", label: "Race/Ethnicity"},
        {id: "5bb76d87-cf7c-4053-a7e8-68b1b3ac459e", label: "Global Diaspora"},
        {id: "1495c8d2-30f6-48d9-8aba-f613e089742e", label: "Non US-perspective"},
        {id: "96f563ed-b64e-4a8a-a901-8a39ea86747e", label: "Demographic Categories"},
        {id: "9e2564b1-3578-4477-908c-b4d3e58132e2", label: "Demographic Categories not to discuss"}
      ],
      sort_order: 3
    },
    {
      ...
      questions: [
        ...
        {id: "6f1fbfe7-1819-446d-860c-46bdc6582a01", label: "Bio"},
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "e40a031b-1633-49da-a742-e1da5ab44f7f", label: "Platforms for Online"},
        {id: "1f119e51-0961-4450-a47f-28cdd05abd8a", label: "6 to 12 ideas"},
        {id: "8250d215-6fd2-4367-a03c-b03a597f6bc2", label: "Interested Items"},
      ],
      sort_order: 4
    ...
    },
    {
      ...
      questions: [
        {id: "4f5d73fb-ae2d-4500-bbab-72868926b89a", label: "Attendance Type"},
        {id: "bdd5ab7d-0f66-431f-a71b-e10b43d7a5cd", label: "Attending or Virtual Member"},
        {id: "6f1fbfe7-1819-446d-860c-46bdc6582a01", label: "Bio"},
        {id: "771fe6b4-dea6-466b-9634-b8425a11eb4d", label: "Pronunciation Guide"},
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "e350f72b-d80a-4ee1-a930-d3ec07ed9413", label: "Other Languages"},
        {id: "89794376-82f7-4d3a-8e0a-489b88907169", label: "Accessibility"},
        {id: "585b5aae-fef9-40ec-a5dd-e3c2028935db", label: "Accessibility Concerns"},
        {id: "f9a97d53-7742-46ea-9fc0-6d3881f703cf", label: "Interest in Diversity Review"},
        {id: "cba6d692-5e8e-44ae-8461-ba9276a506ee", label: "First Worldcon?"},
        {id: "dbca83ea-17db-42b0-be9c-cf882aedf2ea", label: "Previous Worldcons?"},
        {id: "64cf4020-0d36-4f73-9a71-84f713f6df44", label: "Not on Panel with"},
        {id: "91f0fb22-5e91-45c8-ac72-044dc5d304e3", label: "Consent - Sensitive Info"},
        {id: "5524695c-5f1e-4e29-ba47-f096afbc0a61", label: "Gender"},
        {id: "05501da1-e501-41a0-adab-0d027dc20c8d", label: "Race/Ethnicity"},
        {id: "70390ef6-a088-4f9b-b625-6414a4ec1da3", label: "Age At Con"},
        {id: "db9a3f6d-4c13-43f4-a52c-666bf72769e8", label: "Romantic or Sexual Orientation"},
        {id: "13f9b56f-5389-4dab-b147-2a8571b035e6", label: "Experience with being Othered"},
        {id: "5bb76d87-cf7c-4053-a7e8-68b1b3ac459e", label: "Global Diaspora"},
        {id: "1495c8d2-30f6-48d9-8aba-f613e089742e", label: "Non US-perspective"},
        {id: "96f563ed-b64e-4a8a-a901-8a39ea86747e", label: "Demographic Categories"},
        {id: "9e2564b1-3578-4477-908c-b4d3e58132e2", label: "Demographic Categories not to discuss"}
    ...
    },
    {
      ...
      questions: [
        ...
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "e350f72b-d80a-4ee1-a930-d3ec07ed9413", label: "Other Languages"},
        {id: "079d07cc-f790-4531-87e3-d2477d08cbac", label: "Finalist for or won Other Awards"},
        {id: "8250d215-6fd2-4367-a03c-b03a597f6bc2", label: "Interested Items"},
      ],
      sort_order: 8
    },
    ...
    # 1e3a71ac-b75b-4ed9-911e-ebf71b5ef36d
    {
      ...
      questions: [
        ...
        {id: "cba6d692-5e8e-44ae-8461-ba9276a506ee", label: "First Worldcon?"},
        {id: "dbca83ea-17db-42b0-be9c-cf882aedf2ea", label: "Previous Worldcons?"},
        {id: "cfd44d2c-d1ba-436a-bb23-88346799434d", label: "Like Info on Other Parts of Con"},
      ],
      sort_order: 11
    },
    # Dances
    ...
    # f39d2e78-6c4e-40b3-b715-53540e2b730a
    {
      ...
      questions: [
        ...
        {id: "dbca83ea-17db-42b0-be9c-cf882aedf2ea", label: "Previous Worldcons?"},
        {id: "cfd44d2c-d1ba-436a-bb23-88346799434d", label: "Like Info on Other Parts of Con"},
        {id: "10a749b6-f5ee-4f7a-b05c-924b8a7307c5", label: "Interested in Giving Presentation or Exhibit on"},
      ],
      sort_order: 13
    },
    # Gaming
    ...
    # 3e89dcac-b122-4602-94eb-a5bc393c359e
    {
      ...
      questions: [
        ...
        {id: "dbca83ea-17db-42b0-be9c-cf882aedf2ea", label: "Previous Worldcons?"},
        {id: "8250d215-6fd2-4367-a03c-b03a597f6bc2", label: "Interested Items"},
        {id: "f9958ca3-d8bc-47eb-b9c1-3198489a5f64", label: "Presentation Topics"},
      ],
      sort_order: 15
    },
    # Book Launches
    ...
    # 0075620f-c61d-453b-b9a4-06d25c7c92e0
    {
      ...
      questions: [
        ...
        {id: "8250d215-6fd2-4367-a03c-b03a597f6bc2", label: "Interested Items"},
        {id: "f9958ca3-d8bc-47eb-b9c1-3198489a5f64", label: "Presentation Topics"},
        {id: "0075620f-c61d-453b-b9a4-06d25c7c92e0", label: "Hosting"}
      ],
      sort_order: 17
    },
    ...
    # 5bb76d87-cf7c-4053-a7e8-68b1b3ac459e
    {
      ...
      questions: [
        {id: "4f5d73fb-ae2d-4500-bbab-72868926b89a", label: "Attendance Type"},
        {id: "bdd5ab7d-0f66-431f-a71b-e10b43d7a5cd", label: "Attending or Virtual Member"},
        {id: "8dc15c3f-e75a-47a3-933c-9cd11c8e1725", label: "May Require Financial Assist"},
        {id: "6f1fbfe7-1819-446d-860c-46bdc6582a01", label: "Bio"},
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "079d07cc-f790-4531-87e3-d2477d08cbac", label: "Finalist for or won Other Awards"},
        {id: "91f0fb22-5e91-45c8-ac72-044dc5d304e3", label: "Consent - Sensitive Info"},
    ...
    # 321a0368-ed98-4b83-ab39-d4eb0f5e46e1
    {
      ...
      questions: [
        ...
        {id: "6f1fbfe7-1819-446d-860c-46bdc6582a01", label: "Bio"},
        {id: "e7c89a9e-3bba-4e6f-b3da-112731cfc4cd", label: "Pronouns"},
        {id: "321a0368-ed98-4b83-ab39-d4eb0f5e46e1", label: "Current or Past Resident of So Cal"}
      ],
      sort_order: 21
    },
    # Moderating Panels
